          ...
          <div className="bg-white/15 backdrop-blur-md border border-white/25 rounded-2xl p-8 md:p-12">
            ...
            <div className="prose prose-lg max-w-none text-white prose-headings:text-white prose-strong:text-white">
              ...
              <section className="mb-8">
                ...
                <p className="text-white leading-relaxed mb-4">We use minimal analytics to improve the platform:</p>
              ...
              <section className="mb-8">
                ...
                <p className="text-white leading-relaxed mb-4">Our platform uses services that may set their own cookies:</p>
              ...
              <section className="mb-8">
                ...
                <p className="text-white leading-relaxed mb-4">You can control cookies through your browser settings:</p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                  <div className="bg-white/5 border border-white/20 rounded-lg p-4">
                    <h4 className="font-semibold text-white mb-2">Chrome</h4>
                    <p className="text-sm text-white/90">Settings &gt; Privacy and Security &gt; Cookies and other site data</p>
                  </div>
                  <div className="bg-white/5 border border-white/20 rounded-lg p-4">
                    <h4 className="font-semibold text-white mb-2">Safari</h4>
                    <p className="text-sm text-white/90">Preferences &gt; Privacy &gt; Manage Website Data</p>
                  </div>
                  <div className="bg-white/5 border border-white/20 rounded-lg p-4">
                    <h4 className="font-semibold text-white mb-2">Firefox</h4>
                    <p className="text-sm text-white/90">Settings &gt; Privacy &amp; Security &gt; Cookies and Site Data</p>
                  </div>
                  <div className="bg-white/5 border border-white/20 rounded-lg p-4">
                    <h4 className="font-semibold text-white mb-2">Edge</h4>
                    <p className="text-sm text-white/90">Settings &gt; Cookies and site permissions &gt; Cookies and site data</p>
                  </div>
                </div>
              ...
              <section className="mb-8">
                ...
                <p className="text-white leading-relaxed mb-4">When using JiGR on iPad Air or mobile browsers:</p>
                <ul className="text-white leading-relaxed list-disc pl-6">
              ...
              <section className="mb-8">
                ...
                <p className="text-white leading-relaxed mb-4">All cookies used by JiGR:</p>
                <ul className="text-white leading-relaxed list-disc pl-6">
              ...
              <section className="mb-8">
                ...
                <p className="text-white leading-relaxed mb-4">By using JiGR:</p>
                <ul className="text-white leading-relaxed list-disc pl-6">
              ...
              <section className="mb-8">
                ...
                <p className="text-white leading-relaxed mb-4">For cookie-related questions or concerns:</p>
                <div className="bg-white/5 border border-white/20 rounded-lg p-4">
                  <p className="text-white leading-relaxed">
