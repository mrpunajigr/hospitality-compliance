          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center py-4">
              <div className="flex items-center space-x-3">
                ...
                <h1 className="text-white text-lg font-semibold">Hospitality Compliance</h1>
              </div>
              ...
              <nav className="flex items-center space-x-4">
                ...
                <a 
                  href="/create-account"
                  className="bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium py-2 px-4 rounded-lg transition-all duration-200"
                >
                  Get Started
                </a>
              </nav>
