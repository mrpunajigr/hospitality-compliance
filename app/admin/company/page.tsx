        ...
        <div className="relative z-10 min-h-screen flex items-center justify-center">
          <div className="bg-white/15 backdrop-blur-lg border border-white/20 rounded-3xl p-8 shadow-2xl">
            <div className="text-center">
              ...
              <p className="text-gray-900 font-medium">Loading Company...</p>
            </div>
          </div>
        </div>
      </div>
              ...
              <div className="bg-white/15 backdrop-blur-lg border border-white/20 rounded-3xl p-8 shadow-2xl">
                ...
                <form className="space-y-6">
                  ...
                  <div className="flex justify-end space-x-4">
                    <button
                      type="button"
                      className="bg-white/20 hover:bg-white/90 text-gray-900 font-medium py-3 px-6 rounded-xl transition-all duration-200 border border-white/30 backdrop-blur-sm"
                    >
                      Cancel
                    </button>
                    <button
