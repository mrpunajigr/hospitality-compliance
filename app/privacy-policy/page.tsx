        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white/15 backdrop-blur-md border border-white/25 rounded-2xl p-8 md:p-12">
            ...
            <div className="prose prose-lg max-w-none text-white prose-headings:text-white prose-strong:text-white">
              ...
              <div className="text-sm text-white/95 mb-8">
              ...
              <section className="mb-8">
                ...
                <ul className="text-white leading-relaxed mb-4 list-disc pl-6">
              ...
              <section className="mb-8">
                ...
                <p className="text-white leading-relaxed mb-4">We use collected information to:</p>
              ...
              <section className="mb-8">
                ...
                <p className="text-white leading-relaxed mb-4">We implement industry-standard security measures including:</p>
                <ul className="text-white leading-relaxed list-disc pl-6">
              ...
              <section className="mb-8">
                ...
                <p className="text-white leading-relaxed mb-4">We do not sell your personal information. We may share data only:</p>
                <ul className="text-white leading-relaxed list-disc pl-6">
              ...
              <section className="mb-8">
                ...
                <p className="text-white leading-relaxed mb-4">You have the right to:</p>
                <ul className="text-white leading-relaxed list-disc pl-6">
              ...
              <section className="mb-8">
                ...
                <p className="text-white leading-relaxed mb-4">We use essential cookies for:</p>
                <ul className="text-white leading-relaxed list-disc pl-6">
              ...
              <section className="mb-8">
                ...
                <p className="text-white leading-relaxed mb-4">Our platform integrates with:</p>
                <ul className="text-white leading-relaxed list-disc pl-6">
              ...
              <section className="mb-8">
                ...
                <p className="text-white leading-relaxed mb-4">We may update this Privacy Statement periodically. Significant changes will be notified via:</p>
                <ul className="text-white leading-relaxed list-disc pl-6">
