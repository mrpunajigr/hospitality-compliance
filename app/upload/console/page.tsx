  ...
  return (
    <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-6 pt-16 pb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8 AdaptiveLayout">
        ...
        {/* Total Uploads */}
        <div className="bg-gray-900/70 border border-gray-600/30 rounded-3xl p-6 relative overflow-hidden">
        ...
        <div className="mb-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="md:col-span-2 lg:col-span-3">
              <div 
                className="bg-gray-900/70 border border-gray-600/30 rounded-3xl p-6 relative overflow-hidden"
              >
                <div className="absolute top-0 right-0 w-20 h-20 bg-green-500/10 rounded-full -mr-10 -mt-10"></div>
                <div className="relative">
