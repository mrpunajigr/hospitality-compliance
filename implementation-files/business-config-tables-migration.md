# Business Configuration Tables Migration

## Issue
Getting 500 error when testing job titles toggles because `business_job_titles` table doesn't exist in database.
...
4. **Run the migration**
5. **Test the job titles toggle again**

## Expected Result
After running this migration, the job titles ConfigCard should work properly with functioning enable/disable toggles.