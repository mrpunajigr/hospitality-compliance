-- Enhanced Google Document AI Extraction Fields Migration
...
-- Create industry presets data
INSERT INTO client_display_configurations (
    client_id, config_name, industry_preset, is_active,
    show_invoice_number, show_items, show_unit_size, show_unit_price, 
    show_sku_code, show_tax, show_estimated_value, show_item_count,
    results_card_layout, group_by_temperature_category
) VALUES 
-- Restaurant preset template (will be copied for new restaurant clients)
('00000000-0000-0000-0000-000000000001', 'restaurant_template', 'restaurant', false,
 true, true, false, false, false, false, true, true,
 'compact', true),

-- Hotel preset template  
('00000000-0000-0000-0000-000000000002', 'hotel_template', 'hotel', false,
 true, true, true, true, false, true, true, true,
 'detailed', true),

-- Cafe preset template
('00000000-0000-0000-0000-000000000003', 'cafe_template', 'cafe', false,
 false, false, false, false, false, false, false, true,
 'minimal', true),

-- Catering preset template
('00000000-0000-0000-0000-000000000004', 'catering_template', 'catering', false,
...
SELECT 
    ...
    (SUM(CASE WHEN (dr.compliance_analysis->>'overallCompliance') = 'compliant' THEN 1 ELSE 0 END) * 100.0 / COUNT(dr.id)) as compliance_rate
FROM clients c
