// Hospitality Compliance SaaS - Authentication & Authorization Helpers
// Multi-tenant auth logic with role-based permissions

import { supabase, getUserClients, hasClientAccess, getUserClientRole } from './supabase'
