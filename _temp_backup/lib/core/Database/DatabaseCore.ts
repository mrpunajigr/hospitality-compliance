...
export class DatabaseCore extends BaseJiGRModule {
  ...
  private createTableQuery<T>(table: string): TableQuery<T> {
    ...
    return {
      select: (columns?: string | string[]) => ((query as any).select(columns as any)) as any,
      insert: (values: any) => ((query as any).insert(values)) as any,
      update: (values: any) => ((query as any).update(values)) as any,
      delete: () => ((query as any).delete()) as any,
      eq: (column: any, value: any) => ((query as any).eq(column as any, value)) as any,
      neq: (column: any, value: any) => ((query as any).neq(column as any, value)) as any,
      gt: (column: any, value: any) => ((query as any).gt(column as any, value)) as any,
      gte: (column: any, value: any) => ((query as any).gte(column as any, value)) as any,
      lt: (column: any, value: any) => ((query as any).lt(column as any, value)) as any,
      lte: (column: any, value: any) => ((query as any).lte(column as any, value)) as any,
      like: (column: any, pattern: string) => ((query as any).like(column as any, pattern)) as any,
      ilike: (column: any, pattern: string) => ((query as any).ilike(column as any, pattern)) as any,
      in: (column: any, values: any[]) => ((query as any).in(column as any, values)) as any,
      is: (column: any, value: any) => ((query as any).is(column as any, value)) as any,
      order: (column: any, options?: any) => ((query as any).order(column as any, options)) as any,
      range: (from: number, to: number) => ((query as any).range(from, to)) as any,
      limit: (count: number) => ((query as any).limit(count)) as any,
      single: () => ((query as any).single()) as any,
      maybeSingle: () => ((query as any).maybeSingle()) as any,
